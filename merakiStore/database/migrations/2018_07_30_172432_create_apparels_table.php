...
class CreateApparelsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('apparels_products', function (Blueprint $table) {

            // Primary Key
            $table->string('apparel_id')->primary();
            // Apparel Type: Formal Shirts / Sports Tees / Polo Shirts etc.
            $table->string('apparel_type');
            // Apparel Heading: Alan Jones Men's Hooded Sweatshirt
    ...
    {
        Schema::dropIfExists('apparels_products');
    }
}
