...
class CreateMomentosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('momentos_products', function (Blueprint $table) {

          // Primary Key
          $table->string('momento_id')->primary();
          // Electronics Type: Wooden / Metal / Crystal etc.
          $table->string('momento_type');
    ...
    {
        Schema::dropIfExists('momentos_products');
    }
}
