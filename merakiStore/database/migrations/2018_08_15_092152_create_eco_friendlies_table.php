...
class CreateEcoFriendliesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ecofriendly_products', function (Blueprint $table) {

          // Primary Key
          $table->string('ecofriendly_product_id')->primary();
          // Electronics Type: Jute Bags / Paper Bags etc.
          $table->string('ecofriendly_type');
    ...
    {
        Schema::dropIfExists('ecofriendly_products');
    }
}
