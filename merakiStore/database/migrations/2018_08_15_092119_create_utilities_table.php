...
class CreateUtilitiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('utility_products', function (Blueprint $table) {

          // Primary Key
          $table->string('utility_product_id')->primary();
          // Electronics Type: Coffee Mugs / Lunch Boxes / Glass Bottles etc.
    ...
    {
        Schema::dropIfExists('utility_products');
    }
}
