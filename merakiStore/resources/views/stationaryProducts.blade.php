  ...
  <section id="products" class="md-5">
    <div class="container">
      <p class="md-3">
        ...
        <i class="fa fa-angle-right"></i>
        <a href="{{ url($stationaryTypeUrl) }}" style="text-decoration: none;" class="text-secondary">{{ $stationaryTypeDescr }}</a>
      </p>
      <h5 class="section-title h2">{{ $stationaryTypeDescr }}</h5>
      <div class="infinite-scroll">
        <div class="row">
          ...
          <div class="col-sm-3 col-xs-6"><!-- Individual Product Display -->
              <div class="frontside">
                  <div class="card">
                    <a href="/categories/apparels/{{ $row['stationary_type'] }}/{{ $row['stationary_product_id'] }}" style="text-decoration: none;" target="_blank">
...
<script type="text/javascript">
      ...
      $(function() {
          $('.infinite-scroll').jscroll({
              autoTrigger: true,
              loadingHtml: '<img class="center-block" src="{{ url('/images/custom/loading.gif') }}" alt="Loading..." />',
              padding: 20,
